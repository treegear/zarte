		...
		<div class="card border-0">
			<div class="card-header bg-transparent border-0 p-5 pb-0">
				<span class="col-lg-12 row">
					<h3 class="mb-0 col-lg-6"> Add Products </h3>
				</span>
			</div>
			<div class="card-body pt-3 collapse multi-collapse show" id="metta_div_id">
				<form action="{{route('products.store')}}" id="myform_1" method="post" enctype="multipart/form-data">
					@csrf
					{{method_field('put')}}  
					<div class="row">						
						<div class="form-group col-sm-4">
							...
							<select name="pro_pc_id" class="form-control boxbrd fill" required>
								...
								@foreach($pc_list as $pc_row)
									<option value="{{ $pc_row['pc_id'] }}">{{ $pc_row['pc_name'] }}</option>
								@endforeach 
							</select>
						</div>
						<div class="form-group col-sm-4">
							<label class="form-label">Slug</label>
							<input type="text" name="pro_slug" value="" class="form-control menu_slug" placeholder="Enter Slug" readonly>
						</div>
						<div class="form-group col-sm-4">
							<label class="form-label">Metta Tittle</label>
							<input type="text" name="pro_metta_title" value="" class="form-control  menu_title" placeholder="Enter Metta Tittle">
						</div> 
						<div class="form-group col-lg-12"> 
							<label class="form-label">Metta Description</label>
							<textarea class="form-control" name="pro_metta_desc" placeholder="Metta Description"> </textarea> 
						</div>
						<div class="form-group col-lg-12"> 
							<label class="form-label">Metta Keywords</label>
							<textarea class="form-control" name="pro_metta_keywords" placeholder="Metta Keywords"> </textarea> 
						</div>
						<div class="form-group col-sm-4">
							<label class="form-label">Name</label>
							<input type="text" name="pro_title" value="" class="form-control" placeholder="Enter Name">
						</div> 
						...
						<div class="form-group col-sm-2">
							...
							<input type="text" name="pro_price" value="" class="form-control" placeholder="Enter Price">
						</div>						

						<div class="form-group col-sm-2">
							<label class="form-label">Discount Price</label>
							<input type="text" name="pro_s_price" value="" class="form-control" placeholder="Enter Discount Price">
						</div>
						<div class="form-group col-lg-12"> 
							<label class="form-label">Description</label>
							<textarea class="form-control" name="pro_desc" placeholder="Description"> </textarea> 
						</div>   
						
						<div class="form-group col-lg-12"> 
							<label class="form-label">Features</label>
							<textarea class="form-control" id="editor_id" name="pro_features" placeholder=" Features"></textarea> 
						</div> 
	...
	$(function () {
	  	...
	  	$('#myform_1').validate({
			...
			messages: {
				...
				pro_img: "Please select the image", 
