                        ...
                        @csrf
                         ...
                         <input type="hidden" name="id" value="{{$user->id}}">
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="email" name="email" value="{{$user->email}}" class="form-control" placeholder="Enter Email" readonly="">
                              </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                 <input type="text"  name="username" value="{{ $user->username}}" class="form-control" placeholder="Enter User Name" readonly="">
                              </div>
                           ...
                           <label class="col-sm-2 col-form-label">User Role</label>
                              ...
                              @endphp 
                              <select disabled="" name="user_type[]" class="form-control boxbrd fill" multiple>
                              <option value=''>Select User Role</option>
                              <option value="qc" {{ in_array("qc", $type)?'selected':'' }}>QC Officer</option>
                              <option value="prodn" {{ in_array("prodn", $type)?'selected':'' }}>Production Officer</option>
                            <option value="guest" {{ in_array("guest", $type)?'selected':'' }}>Guest</option>
                              </select>
                              </div>
